        ...
        try:
            ...
            if response.images:
                ...
                if os.path.exists(output_path):
                    print(f"✓ Image saved to: {output_path} ({os.path.getsize(output_path)} bytes)")
                    return output_path
                else:
                    print(f"✗ Image file was not created: {output_path}")
                    return None
            else:
                print("✗ No images were generated by Imagen")
                return None
